...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<a href="inscription.html" class="smoothScroll">Inscription</a>
	    ...
	    <div class="project-wrapper">
	      <div class="project">
	        <div class="photo-wrapper">
	          <div class="photo">
	            <a class="fancybox" href="http://www.dailymotion.com/embed/video/x2cjvdc"><img class="img-responsive" style="height:180px" src="assets/img/img1.png" alt=""></a>
	          </div>
	  ...
	  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
	    <div class="project-wrapper">
	      <div class="project">
	        <div class="photo-wrapper">
	          <div class="photo">
	            <a class="fancybox" href="http://www.dailymotion.com/embed/video/x2cjvte"><img class="img-responsive" style="height:220px;" src="assets/img/img2.png" alt=""></a>
	          </div>
	          <div class="overlay"></div>
	        </div>
	      </div>
	  ...
	  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
	    <div class="project-wrapper">
	      <div class="project">
	        <div class="photo-wrapper">
	          <div class="photo">
	            <a class="fancybox" href="http://www.dailymotion.com/embed/video/x2cjwhu"><img class="img-responsive" style="height:180px" src="assets/img/img3.png" alt=""></a>
	          </div>
	          <div class="overlay"></div>
	        </div>
	      </div>
...
$fichier_xml = "http://www.dalloz-actualite.fr/actualites/feed.xml"; # Placez ici l'adresse du flux
...
echo "<a class='a1' style='margin-left: 11%;margin-top:-20%;' href=\"".$link[1]."\" target=\"_blank\">".$title[1]."</a><br />";
}
}
}
?></span>
...
Actus et Tests auto sur Turbo.fr : www.turbo.fr http://www.turbo.fr/divers/tutorial-xml.php#ixzz3TEclGeuD	
      </div><!--/row -->
    </div><!-- /container -->
  </div>
